class GOATSplashScreen extends Phaser.Scene {
  ...
  preload() {
      // Carregar recursos
      this.load.image('GOATLogo', './assets/GOATLogoRedesignBeh.png');
    //   this.load.audio('ambientSound', '/assets/sounds/swoosh2.wav');
  ...
  create() {
      ...
      logo.setScale(1); // Ajustar escala da imagem conforme necessário
